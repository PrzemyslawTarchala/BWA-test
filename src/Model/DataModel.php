...
class DataModel extends AbstractModel
{
	...
	public function totalMonthIncomeDifference(): array 
	{
		$monthIncome = $this->totalMonthIncome();
		$monthExpense = $this->totalMonthExpense();
		$monthDifference = $monthIncome - $monthExpense;

		return $monthIncomeExpenseDifference = [
			"monthIncome" => $monthIncome,
			"monthExpense" => $monthExpense,
			"monthDiffernce" => $monthDifference
		];
	}
	...
	private function totalMonthIncome(): int 
	{
		$loggedUserId = $_SESSION['userId'];
	...
	private function totalMonthExpense(): int 
	{
		$loggedUserId = $_SESSION['userId'];
